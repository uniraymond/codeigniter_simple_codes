	            ...
	            <div class="float-left blog">     
					...
					<div class="blog_title">
		                ...
		                <div class="cls"><?=@word_limiter($blogrow->body, 100)?></div>
		  				<div class="cls"><span class="readmore"><?php //echo anchor('comment/comments/'.$blogrow->id, 'Read More')?><a herf="#" id="readmore_<?=$blogrow->id?>" class="readmore">Read More</a></span></div>   
                        </div>
						<div class="cls"></div> 
...
jQuery.ajax({
	...
	success:function(msg){
		$("#blogview_<?=$blogrow->id?>").html(msg);
			 ...
			 <?php else: ?>
				 <div class="float-left blog">
				      This category Blog will be coming shortly!
				 </div>
			<?php endif; ?>
            <div class="clear-both"></div>
